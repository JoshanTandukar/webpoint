...
class CustomColors {
  ...
  static Color? backgroundVoiceColor;
  static Color? backgroundMMSColor;
  static Color? backgroundSMSColor;
  ...
  static Color? baseInboundIVRColor;
  static Color? channelExpiredColor;
  ...
  static const Color _l_inbound_color = Color(0xFFFDF8F2);
  static const Color _l_expired_color = Color(0xffB099C9);
  ...
  static const Color _c_voice_color = Color(0xFFEEF5E8);
  static const Color _c_sms_color = Color(0xFFE9F0FE);
  static const Color _c_mms_color = Color(0xFFF3F2F4);
  ...
  static void _loadDarkColors() {
    ...
    baseInboundIVRColor = _l_inbound_color;
    channelExpiredColor = _l_expired_color;
    ...
    channelExpiredColor = _d_expired_color;
    ...
    backgroundVoiceColor = _c_voice_color;
    backgroundSMSColor = _c_sms_color;
    backgroundMMSColor = _c_mms_color;
